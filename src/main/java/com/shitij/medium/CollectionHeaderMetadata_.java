...
public class CollectionHeaderMetadata_ {

    @JsonProperty("title")
    private String title;
    @JsonProperty("backgroundImage")
    private BackgroundImage__ backgroundImage;
    @JsonProperty("logoImage")
    private LogoImage__ logoImage;
    ...
    @JsonProperty("backgroundImage")
    public BackgroundImage__ getBackgroundImage() {
        return backgroundImage;
    }

    @JsonProperty("backgroundImage")
    public void setBackgroundImage(BackgroundImage__ backgroundImage) {
        this.backgroundImage = backgroundImage;
    }

    @JsonProperty("logoImage")
    public LogoImage__ getLogoImage() {
        return logoImage;
    }

    @JsonProperty("logoImage")
    public void setLogoImage(LogoImage__ logoImage) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CollectionHeaderMetadata_) == false) {
            return false;
        }
        CollectionHeaderMetadata_ rhs = ((CollectionHeaderMetadata_) other);
