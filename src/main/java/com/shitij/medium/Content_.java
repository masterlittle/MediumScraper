...
public class Content_ {
    ...
    private PostDisplay_ postDisplay;
    @JsonIgnore
    ...
    @JsonProperty("postDisplay")
    public PostDisplay_ getPostDisplay() {
        return postDisplay;
    }

    @JsonProperty("postDisplay")
    public void setPostDisplay(PostDisplay_ postDisplay) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Content_) == false) {
            return false;
        }
        Content_ rhs = ((Content_) other);
