...
public class DefaultBackgroundSpectrum_ {

    @JsonProperty("colorPoints")
    private List<ColorPoint___> colorPoints = null;
    ...
    @JsonProperty("colorPoints")
    public List<ColorPoint___> getColorPoints() {
        return colorPoints;
    }

    @JsonProperty("colorPoints")
    public void setColorPoints(List<ColorPoint___> colorPoints) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DefaultBackgroundSpectrum_) == false) {
            return false;
        }
        DefaultBackgroundSpectrum_ rhs = ((DefaultBackgroundSpectrum_) other);
