...
public class Header {
    ...
    private BackgroundImage_ backgroundImage;
    @JsonProperty("logoImage")
    private LogoImage_ logoImage;
    ...
    @JsonProperty("backgroundImage")
    public BackgroundImage_ getBackgroundImage() {
        return backgroundImage;
    }

    @JsonProperty("backgroundImage")
    public void setBackgroundImage(BackgroundImage_ backgroundImage) {
        this.backgroundImage = backgroundImage;
    }

    @JsonProperty("logoImage")
    public LogoImage_ getLogoImage() {
        return logoImage;
    }

    @JsonProperty("logoImage")
    public void setLogoImage(LogoImage_ logoImage) {
