...
public class HighlightSpectrum {
    ...
    private List<ColorPoint__> colorPoints = null;
    ...
    @JsonProperty("colorPoints")
    public List<ColorPoint__> getColorPoints() {
        return colorPoints;
    }

    @JsonProperty("colorPoints")
    public void setColorPoints(List<ColorPoint__> colorPoints) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HighlightSpectrum) == false) {
            return false;
        }
        HighlightSpectrum rhs = ((HighlightSpectrum) other);
