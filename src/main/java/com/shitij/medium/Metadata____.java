...
public class Metadata____ {
    ...
    private CoverImage_ coverImage;
    @JsonIgnore
    ...
    @JsonProperty("coverImage")
    public CoverImage_ getCoverImage() {
        return coverImage;
    }

    @JsonProperty("coverImage")
    public void setCoverImage(CoverImage_ coverImage) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Metadata____) == false) {
            return false;
        }
        Metadata____ rhs = ((Metadata____) other);
