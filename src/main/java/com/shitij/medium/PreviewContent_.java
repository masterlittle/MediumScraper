...
public class PreviewContent_ {

    @JsonProperty("bodyModel")
    private BodyModel_ bodyModel;
    ...
    @JsonProperty("bodyModel")
    public BodyModel_ getBodyModel() {
        return bodyModel;
    }

    @JsonProperty("bodyModel")
    public void setBodyModel(BodyModel_ bodyModel) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PreviewContent_) == false) {
            return false;
        }
        PreviewContent_ rhs = ((PreviewContent_) other);
