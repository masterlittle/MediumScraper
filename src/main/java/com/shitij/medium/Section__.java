...
public class Section__ {
    ...
    private CollectionHeaderMetadata_ collectionHeaderMetadata;
    @JsonProperty("postListMetadata")
    private PostListMetadata_ postListMetadata;
    @JsonIgnore
    ...
    @JsonProperty("collectionHeaderMetadata")
    public CollectionHeaderMetadata_ getCollectionHeaderMetadata() {
        return collectionHeaderMetadata;
    }

    @JsonProperty("collectionHeaderMetadata")
    public void setCollectionHeaderMetadata(CollectionHeaderMetadata_ collectionHeaderMetadata) {
        this.collectionHeaderMetadata = collectionHeaderMetadata;
    }

    @JsonProperty("postListMetadata")
    public PostListMetadata_ getPostListMetadata() {
        return postListMetadata;
    }

    @JsonProperty("postListMetadata")
    public void setPostListMetadata(PostListMetadata_ postListMetadata) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Section__) == false) {
            return false;
        }
        Section__ rhs = ((Section__) other);
