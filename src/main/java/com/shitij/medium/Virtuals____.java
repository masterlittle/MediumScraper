...
public class Virtuals____ {
    ...
    private UserPostRelation_ userPostRelation;
    ...
    @JsonProperty("previewImage")
    public PreviewImage_ getPreviewImage() {
        return previewImage;
    }

    @JsonProperty("previewImage")
    public void setPreviewImage(PreviewImage_ previewImage) {
    ...
    @JsonProperty("userPostRelation")
    public UserPostRelation_ getUserPostRelation() {
        return userPostRelation;
    }

    @JsonProperty("userPostRelation")
    public void setUserPostRelation(UserPostRelation_ userPostRelation) {
