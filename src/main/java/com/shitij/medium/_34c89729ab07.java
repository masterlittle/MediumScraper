...
public class _34c89729ab07 {
    ...
    private PreviewContent_ previewContent;
    ...
    @JsonProperty("virtuals")
    public Virtuals____ getVirtuals() {
        return virtuals;
    }

    @JsonProperty("virtuals")
    public void setVirtuals(Virtuals____ virtuals) {
    ...
    @JsonProperty("previewContent")
    public PreviewContent_ getPreviewContent() {
        return previewContent;
    }

    @JsonProperty("previewContent")
    public void setPreviewContent(PreviewContent_ previewContent) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _34c89729ab07) == false) {
            return false;
        }
        _34c89729ab07 rhs = ((_34c89729ab07) other);
