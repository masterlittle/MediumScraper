...
public class SocialStats_ {

    @JsonProperty("42753d992dfc")
    private _42753d992dfc__ _42753d992dfc;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("42753d992dfc")
    public _42753d992dfc__ get42753d992dfc() {
        return _42753d992dfc;
    }

    @JsonProperty("42753d992dfc")
    public void set42753d992dfc(_42753d992dfc__ _42753d992dfc) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SocialStats_) == false) {
            return false;
        }
        SocialStats_ rhs = ((SocialStats_) other);
