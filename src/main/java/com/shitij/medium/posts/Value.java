...
public class Value {
    ...
    @JsonProperty("hightowerMinimumGuaranteeStartsAt")
    private long hightowerMinimumGuaranteeStartsAt;
    @JsonProperty("hightowerMinimumGuaranteeEndsAt")
    private long hightowerMinimumGuaranteeEndsAt;
    @JsonProperty("type")
    private String type;
    @JsonIgnore
    ...
    @JsonProperty("hightowerMinimumGuaranteeStartsAt")
    public long getHightowerMinimumGuaranteeStartsAt() {
        return hightowerMinimumGuaranteeStartsAt;
    }

    @JsonProperty("hightowerMinimumGuaranteeStartsAt")
    public void setHightowerMinimumGuaranteeStartsAt(long hightowerMinimumGuaranteeStartsAt) {
        this.hightowerMinimumGuaranteeStartsAt = hightowerMinimumGuaranteeStartsAt;
    }

    @JsonProperty("hightowerMinimumGuaranteeEndsAt")
    public long getHightowerMinimumGuaranteeEndsAt() {
        return hightowerMinimumGuaranteeEndsAt;
    }

    @JsonProperty("hightowerMinimumGuaranteeEndsAt")
    public void setHightowerMinimumGuaranteeEndsAt(long hightowerMinimumGuaranteeEndsAt) {
