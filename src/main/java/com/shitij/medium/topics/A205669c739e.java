...
public class A205669c739e {
    ...
    @JsonProperty("image")
    private Image__________________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image__________________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image__________________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof A205669c739e) == false) {
            return false;
        }
        A205669c739e rhs = ((A205669c739e) other);
