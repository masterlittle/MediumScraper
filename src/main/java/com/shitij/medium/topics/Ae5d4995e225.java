...
public class Ae5d4995e225 {
    ...
    @JsonProperty("image")
    private Image____________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image____________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image____________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ae5d4995e225) == false) {
            return false;
        }
        Ae5d4995e225 rhs = ((Ae5d4995e225) other);
