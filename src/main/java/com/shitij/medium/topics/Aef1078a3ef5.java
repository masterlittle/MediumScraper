...
public class Aef1078a3ef5 {
    ...
    @JsonProperty("image")
    private Image____________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image____________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image____________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aef1078a3ef5) == false) {
            return false;
        }
        Aef1078a3ef5 rhs = ((Aef1078a3ef5) other);
