...
public class Af49579e220a {
    ...
    @JsonProperty("image")
    private Image________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Af49579e220a) == false) {
            return false;
        }
        Af49579e220a rhs = ((Af49579e220a) other);
