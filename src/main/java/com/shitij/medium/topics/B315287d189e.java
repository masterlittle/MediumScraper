...
public class B315287d189e {
    ...
    @JsonProperty("image")
    private Image________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof B315287d189e) == false) {
            return false;
        }
        B315287d189e rhs = ((B315287d189e) other);
