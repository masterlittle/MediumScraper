...
public class Ba2d3ab15ed6 {
    ...
    @JsonProperty("image")
    private Image____________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image____________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image____________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ba2d3ab15ed6) == false) {
            return false;
        }
        Ba2d3ab15ed6 rhs = ((Ba2d3ab15ed6) other);
