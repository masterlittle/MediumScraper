...
public class Bceaf21c0fb7 {
    ...
    @JsonProperty("image")
    public Image________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bceaf21c0fb7) == false) {
            return false;
        }
        Bceaf21c0fb7 rhs = ((Bceaf21c0fb7) other);
