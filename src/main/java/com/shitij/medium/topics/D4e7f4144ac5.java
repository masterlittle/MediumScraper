...
public class D4e7f4144ac5 {
    ...
    @JsonProperty("image")
    private Image___________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image___________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image___________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof D4e7f4144ac5) == false) {
            return false;
        }
        D4e7f4144ac5 rhs = ((D4e7f4144ac5) other);
