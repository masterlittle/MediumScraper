...
public class Decb52b64abf {
    ...
    @JsonProperty("image")
    private Image_________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Decb52b64abf) == false) {
            return false;
        }
        Decb52b64abf rhs = ((Decb52b64abf) other);
