...
public class Dfcc5a84e698 {
    ...
    @JsonProperty("image")
    private Image_________________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_________________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_________________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dfcc5a84e698) == false) {
            return false;
        }
        Dfcc5a84e698 rhs = ((Dfcc5a84e698) other);
