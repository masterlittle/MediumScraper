...
public class Ff18cfb862d2 {
    ...
    @JsonProperty("image")
    private Image____________________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image____________________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image____________________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ff18cfb862d2) == false) {
            return false;
        }
        Ff18cfb862d2 rhs = ((Ff18cfb862d2) other);
