...
public class Image____________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image____________________) == false) {
            return false;
        }
        Image____________________ rhs = ((Image____________________) other);
