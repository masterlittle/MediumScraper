...
public class Image_____________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_____________________) == false) {
            return false;
        }
        Image_____________________ rhs = ((Image_____________________) other);
