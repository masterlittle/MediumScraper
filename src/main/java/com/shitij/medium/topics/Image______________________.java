...
public class Image______________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image______________________) == false) {
            return false;
        }
        Image______________________ rhs = ((Image______________________) other);
