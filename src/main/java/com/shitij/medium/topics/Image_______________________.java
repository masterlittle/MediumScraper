...
public class Image_______________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_______________________) == false) {
            return false;
        }
        Image_______________________ rhs = ((Image_______________________) other);
