...
public class Image________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image________________________) == false) {
            return false;
        }
        Image________________________ rhs = ((Image________________________) other);
