...
public class Image_________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_________________________) == false) {
            return false;
        }
        Image_________________________ rhs = ((Image_________________________) other);
