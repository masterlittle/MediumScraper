...
public class Image__________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__________________________) == false) {
            return false;
        }
        Image__________________________ rhs = ((Image__________________________) other);
