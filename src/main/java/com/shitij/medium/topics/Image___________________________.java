...
public class Image___________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image___________________________) == false) {
            return false;
        }
        Image___________________________ rhs = ((Image___________________________) other);
