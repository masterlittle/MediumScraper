...
public class Image________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image________________________________) == false) {
            return false;
        }
        Image________________________________ rhs = ((Image________________________________) other);
