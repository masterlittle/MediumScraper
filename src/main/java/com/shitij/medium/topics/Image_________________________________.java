...
public class Image_________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_________________________________) == false) {
            return false;
        }
        Image_________________________________ rhs = ((Image_________________________________) other);
