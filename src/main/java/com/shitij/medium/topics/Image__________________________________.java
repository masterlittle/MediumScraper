...
public class Image__________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__________________________________) == false) {
            return false;
        }
        Image__________________________________ rhs = ((Image__________________________________) other);
