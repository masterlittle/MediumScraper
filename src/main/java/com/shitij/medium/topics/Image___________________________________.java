...
public class Image___________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image___________________________________) == false) {
            return false;
        }
        Image___________________________________ rhs = ((Image___________________________________) other);
