...
public class Image____________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image____________________________________) == false) {
            return false;
        }
        Image____________________________________ rhs = ((Image____________________________________) other);
