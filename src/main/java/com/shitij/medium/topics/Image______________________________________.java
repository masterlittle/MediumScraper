...
public class Image______________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image______________________________________) == false) {
            return false;
        }
        Image______________________________________ rhs = ((Image______________________________________) other);
