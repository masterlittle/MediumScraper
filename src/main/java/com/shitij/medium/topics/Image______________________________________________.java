...
public class Image______________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image______________________________________________) == false) {
            return false;
        }
        Image______________________________________________ rhs = ((Image______________________________________________) other);
