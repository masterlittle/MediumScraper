...
public class Image_______________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_______________________________________________) == false) {
            return false;
        }
        Image_______________________________________________ rhs = ((Image_______________________________________________) other);
