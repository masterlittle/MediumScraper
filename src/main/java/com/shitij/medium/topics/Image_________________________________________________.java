...
public class Image_________________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image_________________________________________________) == false) {
            return false;
        }
        Image_________________________________________________ rhs = ((Image_________________________________________________) other);
