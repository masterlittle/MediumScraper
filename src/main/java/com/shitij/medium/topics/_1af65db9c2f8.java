...
public class _1af65db9c2f8 {
    ...
    @JsonProperty("image")
    private Image_________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _1af65db9c2f8) == false) {
            return false;
        }
        _1af65db9c2f8 rhs = ((_1af65db9c2f8) other);
