...
public class _205a8f70c356 {
    ...
    @JsonProperty("image")
    public Image_________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _205a8f70c356) == false) {
            return false;
        }
        _205a8f70c356 rhs = ((_205a8f70c356) other);
