...
public class _22d054b693da {
    ...
    @JsonProperty("image")
    private Image_____________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_____________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_____________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _22d054b693da) == false) {
            return false;
        }
        _22d054b693da rhs = ((_22d054b693da) other);
