...
public class _24853457a119 {
    ...
    @JsonProperty("image")
    private Image______________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image______________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image______________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _24853457a119) == false) {
            return false;
        }
        _24853457a119 rhs = ((_24853457a119) other);
