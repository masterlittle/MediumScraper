...
public class _29bb77781daf {
    ...
    @JsonProperty("image")
    private Image_____________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_____________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_____________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _29bb77781daf) == false) {
            return false;
        }
        _29bb77781daf rhs = ((_29bb77781daf) other);
