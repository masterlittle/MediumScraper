...
public class _308a25bedcb5 {
    ...
    @JsonProperty("image")
    public Image______ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image______ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _308a25bedcb5) == false) {
            return false;
        }
        _308a25bedcb5 rhs = ((_308a25bedcb5) other);
