...
public class _40c8e34e04ce {
    ...
    @JsonProperty("image")
    private Image___________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image___________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image___________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _40c8e34e04ce) == false) {
            return false;
        }
        _40c8e34e04ce rhs = ((_40c8e34e04ce) other);
