...
public class _4861fee224fd {
    ...
    @JsonProperty("image")
    private Image______________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image______________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image______________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _4861fee224fd) == false) {
            return false;
        }
        _4861fee224fd rhs = ((_4861fee224fd) other);
