...
public class _55f1c20aba7a {
    ...
    @JsonProperty("image")
    private Image___________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image___________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image___________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _55f1c20aba7a) == false) {
            return false;
        }
        _55f1c20aba7a rhs = ((_55f1c20aba7a) other);
