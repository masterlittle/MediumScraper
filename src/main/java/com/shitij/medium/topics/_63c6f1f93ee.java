...
public class _63c6f1f93ee {
    ...
    @JsonProperty("image")
    private Image______________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image______________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image______________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _63c6f1f93ee) == false) {
            return false;
        }
        _63c6f1f93ee rhs = ((_63c6f1f93ee) other);
