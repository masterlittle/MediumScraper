...
public class _76d56a8194b9 {
    ...
    @JsonProperty("image")
    public Image_______ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_______ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _76d56a8194b9) == false) {
            return false;
        }
        _76d56a8194b9 rhs = ((_76d56a8194b9) other);
