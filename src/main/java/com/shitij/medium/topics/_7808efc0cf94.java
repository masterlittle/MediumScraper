...
public class _7808efc0cf94 {
    ...
    @JsonProperty("image")
    private Image_______________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_______________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_______________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _7808efc0cf94) == false) {
            return false;
        }
        _7808efc0cf94 rhs = ((_7808efc0cf94) other);
