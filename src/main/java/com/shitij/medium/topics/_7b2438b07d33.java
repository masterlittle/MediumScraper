...
public class _7b2438b07d33 {
    ...
    @JsonProperty("image")
    public Image__________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image__________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _7b2438b07d33) == false) {
            return false;
        }
        _7b2438b07d33 rhs = ((_7b2438b07d33) other);
