...
public class _80e54e691fc9 {
    ...
    @JsonProperty("image")
    private Image_________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _80e54e691fc9) == false) {
            return false;
        }
        _80e54e691fc9 rhs = ((_80e54e691fc9) other);
