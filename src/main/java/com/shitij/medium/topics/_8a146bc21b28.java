...
public class _8a146bc21b28 {
    ...
    @JsonProperty("image")
    private Image_______________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image_______________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image_______________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _8a146bc21b28) == false) {
            return false;
        }
        _8a146bc21b28 rhs = ((_8a146bc21b28) other);
