...
public class _9213b0063bcc {
    ...
    @JsonProperty("image")
    private Image__________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image__________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image__________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _9213b0063bcc) == false) {
            return false;
        }
        _9213b0063bcc rhs = ((_9213b0063bcc) other);
