...
public class _95e38a3034fb {
    ...
    @JsonProperty("image")
    private Image__________________________________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image__________________________________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image__________________________________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _95e38a3034fb) == false) {
            return false;
        }
        _95e38a3034fb rhs = ((_95e38a3034fb) other);
