...
public class _9f59f758e8e0 {
    ...
    @JsonProperty("image")
    private Image____________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image____________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image____________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _9f59f758e8e0) == false) {
            return false;
        }
        _9f59f758e8e0 rhs = ((_9f59f758e8e0) other);
