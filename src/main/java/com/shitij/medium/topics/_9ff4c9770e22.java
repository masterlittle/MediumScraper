...
public class _9ff4c9770e22 {
    ...
    @JsonProperty("image")
    private Image__________________________ image;
    @JsonProperty("name")
    private String name;
    ...
    @JsonProperty("image")
    public Image__________________________ getImage() {
        return image;
    }

    @JsonProperty("image")
    public void setImage(Image__________________________ image) {
        this.image = image;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _9ff4c9770e22) == false) {
            return false;
        }
        _9ff4c9770e22 rhs = ((_9ff4c9770e22) other);
